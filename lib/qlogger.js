console.log("AR: included qlogger");
...
function QLogger( loglevel, writerType ) {
    if (this === global || !this) return new QLogger(loglevel, writerType);
...
//msg = '{"name":"KDS","hostname":"work2","pid":22467,"audit":true,"level":"info","remoteAddress":"127.0.0.1","remotePort":58539,"req_id":"-","req":{"method":"GET","url":"/healthcheck","headers":{"host":"localhost:4242"},"httpVersion":"1.1","trailers":{},"version":"1.0.0","timers":{}},"res":{"statusCode":200,"trailer":false},"rusage":{"utime":0,"stime":0,"wtime":0.00018252001609653234,"maxrss":0,"inblock":0,"oublock":0},"query":null,"latency":null,"_audit":true,"msg":"handled:200","time":"2015-01-15T05:04:55.114Z","v":0,"requestId":"-"}';
        }
...
console.log("AR: creating logger");
//return fs.createWriteStream(name, {highWaterMark: 4096000});
