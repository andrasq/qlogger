...
QLogger.LOGLEVELS = {
    ...
    PANIC: 0,   panic: 0,       Panic: 0,       0: 0,   LOG_PANIC: 0,
...
QLogger.prototype.err = function(msg) { this._logit(msg, QLogger.LOG_ERROR); };
...
QLogger.prototype.panic = function(msg) { this._logit(msg, QLogger.LOG_PANIC); };
